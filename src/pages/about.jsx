        ...
        <div >
            ...
            <Grid container direction="row" alignContent="center" justifyContent="center" style={{padding: "0 64px"}} columnSpacing={12} rowSpacing={8} >
                ...
                <Grid item xs={12} sm={12} md={8} style={{ textAlign: "left" }}>
                    <p>Hello there! I am Mhar. I'm a junior and I'm currently studying Computer Science with a concentration in Human-Computer Interaction and Art Practice at Stanford University.</p>
                    <p>I am interested in combining my skills as a human-centered designer and as a full-stack software developer to build websites and applications centered around social good and positive impact. I am currently an intern for an e-commerce start-up called <b>Purposer</b>, which is centered around purposeful spending and ethical consumption and will launch winter of 2022. I am also part of the tech team for the campus newspaper <b>The Stanford Daily</b>, which is a news source for 20,000+ students and staff.</p>
                    ...
                    <p>Outside of academics, I am invested in pop culture and listening to music! I geek over really cool graphic design or UI/UX design. I like dancing in my room and ranking things I like. See what I'm listening to <a href="https://open.spotify.com/user/mhartenorio?si=b4c1e8fe274f464d" className='underlineButtonText' style={{whiteSpace: "nowrap"}}>here!</a></p>
                    <p>:D</p>
                </Grid>
            </Grid>
